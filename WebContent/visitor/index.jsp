...
<div id="header">	
	 ...
	 <!-- Navigation -->
			<div id="navigation">
				<ul>
				    <li class="first"><a href="index.jsp">主&nbsp;&nbsp;页</a></li>
					<li><a href="/ins/notice/queryAll">通知公告</a></li>
				    <li><a href="">事务咨询</a></li>
	...
	<!-- Slider -->
		<div id="slider">
			...
			<div class="slider-content">
				<ul>
				    <li><a href=""><img src="/ins/resources/images/01.png" alt="" /></a></li>
				    <li><a href=""><img src="/ins/resources/images/02.png" alt="" /></a></li>
